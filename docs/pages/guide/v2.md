...
<label for="externalUserId">Init Token:</label>
...
<iframe v-if="iframeSrc" :key=iframeSrc :src="iframeSrc" height="600" frameborder="0" style="1px solid var(--vt-c-divider-light); border-radius: 0.5rem; overflow: hidden;" class="mt-8 mb-8 w-full"></iframe>
